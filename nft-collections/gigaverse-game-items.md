---
icon: sitemap
cover: ../.gitbook/assets/gitbookcover image.png
coverY: 0
---

# Gigaverse Game Items

**Items can be earned and found throughout Gigaverse.** Some items and pieces of gear cannot be found, and must instead be crafted. See [crafting-overview.md](../crafting-and-stations/crafting-overview.md "mention"). Items have different rarities and uses: make sure you read their description to learn about what they can be used for. \
\
...
<table data-full-width="false"><thead><tr><th width="251">Type</th><th width="452">Description</th></tr></thead><tbody><tr><td>Material</td><td>Items used for skill leveling and crafting</td></tr><tr><td>Skin</td><td>Cosmetics used to distinguish yourself in Gigaverse </td></tr><tr><td>Collectible</td><td>May or may not have special uses in-game</td></tr><tr><td><a data-mention href="../crafting-and-stations/alchemy-bench/consumables.md">consumables.md</a></td><td>Items used to provide boosts in combat</td></tr><tr><td><a data-mention href="../crafting-and-stations/workbench/gear.md">gear.md</a></td><td>Items with utility </td></tr></tbody></table>
